...
<div class="main-left-title"><?php echo Yii::t('index', 'HPOOL MINING POOL') ?></div>
...
<div class="main-left-box">
<div class="main-left-title"><?php echo Yii::t('index', 'STRATUM SERVERS') ?></div>
<div class="main-left-inner">
...
<!-- 
<div class="main-left-box">
<div class="main-left-title"><?php echo Yii::t('index', 'LINKS') ?></div>
<div class="main-left-inner">
